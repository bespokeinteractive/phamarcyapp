...
<script>
    ...
    jq(function () {
        ...
        jq("#toDate-display").on("change", function () {
            reloadmyList();
        });
...
<div>
    <input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="Issue Drugs to Account"
           onclick="issueAccountDrug();"/>
        ...
        <div class="info-section">
            <div class="info-header">
                ...
                <div style="margin-top: -5px">
                    ...
                    <input type="text" id="issueName" name="issueName" placeholder="Enter Account Name"
                           title="Enter account Name" style="width: 160px; "/>
